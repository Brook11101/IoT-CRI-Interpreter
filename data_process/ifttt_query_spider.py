...
class IftttQuerySpider(scrapy.Spider):
    name = "ifttt.com"
    ...
    def __init__(self, *args, **kwargs):
        super(IftttQuerySpider, self).__init__(*args, **kwargs)
    ...
    def login_check(self, response):
        ...
        for module_name in self.module_name_list:
            payload = {
                "query": "\n  query DIYLoadServiceQueriesAndFieldsQuery($serviceModuleName: String!) {\n    channel(module_name: $serviceModuleName) {\n      \n  live_channels {\n    id\n    user_name_field\n    offline\n  }\n\n      public_queries {\n        module_name\n        full_module_name\n        normalized_module_name\n        name\n        description\n        id\n        weight\n        tier\n\n        query_fields {\n          name\n          label\n          required\n          shareable\n          hideable\n          field_ui_type\n          normalized_field_type\n          helper_text\n        }\n\n        ingredients {\n          id\n          name\n          normalized_name\n          label\n          note\n          slug\n          value_type\n          example\n        }\n      }\n    }\n  }\n",
            ...
            yield scrapy.Request(
                ...
                headers=headers,
                callback=self.get_query_by_name,
                meta={"module_name": module_name},
            )

    def get_query_by_name(self, response):
        module_name = response.meta["module_name"]
        json_data = response.json()

        with open("./data/query_json/" + module_name + ".json", "w") as f:
